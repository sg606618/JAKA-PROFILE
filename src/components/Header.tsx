      ...
      <header className="flex justify-center items-center bg-[whitesmoke]">
        <nav className="flex justify-between items-center w-full px-1 sm:px-5 md:px-10 py-1">
          ...
          <ul className="sm:flex justify-around w-full max-w-[50rem] hidden">
            <>
              {navLinks.map((items) => (
                <li className="font-semibold text-black tracking-wider cursor-pointer hover:text-[#4D4D4D]">
                  {items}
                </li>
              ))}
            </>
          ...
          <div className="flex justify-between w-20">
            <div className="relative flex justify-center items-center">
              ...
              <div className="w-3 h-3 absolute right-[-.2rem] top-[-.2rem] rounded-full bg-blue-600 flex justify-center items-center">
                <span className="text-[.5rem] font-bold text-white">1</span>
              </div>
            </div>
